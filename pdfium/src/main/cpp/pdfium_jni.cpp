...
#define JNI_FUNC(retType, bindClass, name)  JNIEXPORT retType JNICALL Java_arte_programar_pdfium_##bindClass##_##name
#define JNI_ARGS    JNIEnv *env, jobject thiz

#define LOG_TAG "Pdfium"
...
static void destroyLibraryIfNeed() {
    ...
    if (sLibraryReferenceCount == 0) {
        FPDF_DestroyLibrary();
        LOGI("Pdfium Instance Destroyed!");
    }
}
...
JNI_FUNC(jlong, Pdfium, nativeOpenDocument)(JNI_ARGS, jint fd, jstring password) {

    size_t fileLength = (size_t) getFileSize(fd);
    if (fileLength <= 0) {
        jniThrowException(env, "arte/programar/pdfium/exception/PdfException", "File is empty");
        return -1;
    }
    ...
    if (!document) {
        ...
        if (errorNum == FPDF_ERR_PASSWORD) {
            jniThrowException(env, "arte/programar/pdfium/exception/PdfPasswordException",
                              "Password required or incorrect password.");
        } else {
            char *error = getErrorDescription(errorNum);
            jniThrowExceptionFmt(env, "arte/programar/pdfium/exception/PdfException",
...
JNI_FUNC(jlong, Pdfium, nativeOpenMemDocument)(JNI_ARGS, jbyteArray data, jstring password) {
    DocumentFile *docFile = new DocumentFile();
...
JNI_FUNC(jint, Pdfium, nativeGetPageCount)(JNI_ARGS, jlong documentPtr) {
    DocumentFile *doc = reinterpret_cast<DocumentFile *>(documentPtr);
    return (jint) FPDF_GetPageCount(doc->pdfDocument);
}

JNI_FUNC(void, Pdfium, nativeCloseDocument)(JNI_ARGS, jlong documentPtr) {
    DocumentFile *doc = reinterpret_cast<DocumentFile *>(documentPtr);
    delete doc;
}
...
JNI_FUNC(jlong, Pdfium, nativeLoadPage)(JNI_ARGS, jlong docPtr, jint pageIndex) {
    DocumentFile *doc = reinterpret_cast<DocumentFile *>(docPtr);
    return loadPageInternal(env, doc, (int) pageIndex);
}
JNI_FUNC(jlongArray, Pdfium, nativeLoadPages)(JNI_ARGS, jlong docPtr, jint fromIndex,
                                              jint toIndex) {
    DocumentFile *doc = reinterpret_cast<DocumentFile *>(docPtr);
...
JNI_FUNC(void, Pdfium, nativeClosePage)(JNI_ARGS, jlong pagePtr) { closePageInternal(pagePtr); }
JNI_FUNC(void, Pdfium, nativeClosePages)(JNI_ARGS, jlongArray pagesPtr) {
...
JNI_FUNC(jint, Pdfium, nativeGetPageWidthPixel)(JNI_ARGS, jlong pagePtr, jint dpi) {
    FPDF_PAGE page = reinterpret_cast<FPDF_PAGE>(pagePtr);
    return (jint) (FPDF_GetPageWidth(page) * dpi / 72);
}
JNI_FUNC(jint, Pdfium, nativeGetPageHeightPixel)(JNI_ARGS, jlong pagePtr, jint dpi) {
    FPDF_PAGE page = reinterpret_cast<FPDF_PAGE>(pagePtr);
    return (jint) (FPDF_GetPageHeight(page) * dpi / 72);
}

JNI_FUNC(jint, Pdfium, nativeGetPageWidthPoint)(JNI_ARGS, jlong pagePtr) {
    FPDF_PAGE page = reinterpret_cast<FPDF_PAGE>(pagePtr);
    return (jint) FPDF_GetPageWidth(page);
}
JNI_FUNC(jint, Pdfium, nativeGetPageHeightPoint)(JNI_ARGS, jlong pagePtr) {
    FPDF_PAGE page = reinterpret_cast<FPDF_PAGE>(pagePtr);
    return (jint) FPDF_GetPageHeight(page);
}
JNI_FUNC(jobject, Pdfium, nativeGetPageSizeByIndex)(JNI_ARGS, jlong docPtr, jint pageIndex,
                                                    jint dpi) {
    DocumentFile *doc = reinterpret_cast<DocumentFile *>(docPtr);
    if (doc == NULL) {
    ...
    jclass clazz = env->FindClass("arte/programar/pdfium/util/Size");
...
JNI_FUNC(void, Pdfium, nativeRenderPage)(JNI_ARGS, jlong pagePtr, jobject objSurface,
...
JNI_FUNC(void, Pdfium, nativeRenderPageBitmap)(JNI_ARGS, jlong pagePtr, jobject bitmap,
                                               jint dpi, jint startX, jint startY,
                                               jint drawSizeHor, jint drawSizeVer,
                                               jboolean renderAnnot) {
...
JNI_FUNC(jstring, Pdfium, nativeGetDocumentMetaText)(JNI_ARGS, jlong docPtr, jstring tag) {
...
JNI_FUNC(jobject, Pdfium, nativeGetFirstChildBookmark)(JNI_ARGS, jlong docPtr,
                                                       jobject bookmarkPtr) {
    DocumentFile *doc = reinterpret_cast<DocumentFile *>(docPtr);
...
JNI_FUNC(jobject, Pdfium, nativeGetSiblingBookmark)(JNI_ARGS, jlong docPtr, jlong bookmarkPtr) {
    DocumentFile *doc = reinterpret_cast<DocumentFile *>(docPtr);
...
JNI_FUNC(jstring, Pdfium, nativeGetBookmarkTitle)(JNI_ARGS, jlong bookmarkPtr) {
...
JNI_FUNC(jlong, Pdfium, nativeGetBookmarkDestIndex)(JNI_ARGS, jlong docPtr, jlong bookmarkPtr) {
    DocumentFile *doc = reinterpret_cast<DocumentFile *>(docPtr);
    FPDF_BOOKMARK bookmark = reinterpret_cast<FPDF_BOOKMARK>(bookmarkPtr);
...
JNI_FUNC(jlongArray, Pdfium, nativeGetPageLinks)(JNI_ARGS, jlong pagePtr) {
    FPDF_PAGE page = reinterpret_cast<FPDF_PAGE>(pagePtr);
    int pos = 0;
...
JNI_FUNC(jobject, Pdfium, nativeGetDestPageIndex)(JNI_ARGS, jlong docPtr, jlong linkPtr) {
    DocumentFile *doc = reinterpret_cast<DocumentFile *>(docPtr);
...
JNI_FUNC(jstring, Pdfium, nativeGetLinkURI)(JNI_ARGS, jlong docPtr, jlong linkPtr) {
    DocumentFile *doc = reinterpret_cast<DocumentFile *>(docPtr);
    FPDF_LINK link = reinterpret_cast<FPDF_LINK>(linkPtr);
...
JNI_FUNC(jobject, Pdfium, nativeGetLinkRect)(JNI_ARGS, jlong linkPtr) {
    FPDF_LINK link = reinterpret_cast<FPDF_LINK>(linkPtr);
    FS_RECTF fsRectF;
...
JNI_FUNC(jobject, Pdfium, nativePageCoordinateToDevice)(JNI_ARGS, jlong pagePtr, jint startX,
...
JNI_FUNC(jobject, Pdfium, nativeDeviceCoordinateToPage)(JNI_ARGS, jlong pagePtr, jint startX,
                                                        jint startY, jint sizeX,
...
JNI_FUNC(jlong, Pdfium, nativeLoadTextPage)(JNI_ARGS, jlong docPtr, jint pageIndex) {
    DocumentFile *doc = reinterpret_cast<DocumentFile *>(docPtr);
    return loadTextPageInternal(env, doc, (int) pageIndex);
}

JNI_FUNC(jlongArray, Pdfium, nativeLoadTextPages)(JNI_ARGS, jlong docPtr, jint fromIndex,
                                                  jint toIndex) {
    DocumentFile *doc = reinterpret_cast<DocumentFile *>(docPtr);
...
JNI_FUNC(void, Pdfium, nativeCloseTextPage)(JNI_ARGS, jlong textPagePtr) {
    closeTextPageInternal(textPagePtr);
}

JNI_FUNC(void, Pdfium, nativeCloseTextPages)(JNI_ARGS, jlongArray textPagesPtr) {
...
JNI_FUNC(jint, Pdfium, nativeTextCountChars)(JNI_ARGS, jlong textPagePtr) {
    FPDF_TEXTPAGE textPage = reinterpret_cast<FPDF_TEXTPAGE>(textPagePtr);
    return (jint) FPDFText_CountChars(textPage);// FPDF_TEXTPAGE
}

JNI_FUNC(jint, Pdfium, nativeTextGetUnicode)(JNI_ARGS, jlong textPagePtr, jint index) {
    FPDF_TEXTPAGE textPage = reinterpret_cast<FPDF_TEXTPAGE>(textPagePtr);
    return (jint) FPDFText_GetUnicode(textPage, (int) index);
}

JNI_FUNC(jdoubleArray, Pdfium, nativeTextGetCharBox)(JNI_ARGS, jlong textPagePtr, jint index) {
    FPDF_TEXTPAGE textPage = reinterpret_cast<FPDF_TEXTPAGE>(textPagePtr);
...
JNI_FUNC(jint, Pdfium, nativeTextGetCharIndexAtPos)(JNI_ARGS, jlong textPagePtr, jdouble x,
...
JNI_FUNC(jint, Pdfium, nativeTextGetText)(JNI_ARGS, jlong textPagePtr, jint start_index,
...
JNI_FUNC(jint, Pdfium, nativeTextCountRects)(JNI_ARGS, jlong textPagePtr, jint start_index,
                                             jint count) {
    FPDF_TEXTPAGE textPage = reinterpret_cast<FPDF_TEXTPAGE>(textPagePtr);
    return (jint) FPDFText_CountRects(textPage, (int) start_index, (int) count);
}

JNI_FUNC(jdoubleArray, Pdfium, nativeTextGetRect)(JNI_ARGS, jlong textPagePtr,
                                                  jint rect_index) {
    FPDF_TEXTPAGE textPage = reinterpret_cast<FPDF_TEXTPAGE>(textPagePtr);
    jdoubleArray result = env->NewDoubleArray(4);
    if (result == NULL) {
...
JNI_FUNC(jint, Pdfium, nativeTextGetBoundedTextLength)(JNI_ARGS, jlong textPagePtr,
                                                       jdouble left,
...
JNI_FUNC(jint, Pdfium, nativeTextGetBoundedText)(JNI_ARGS, jlong textPagePtr, jdouble left,
...
JNI_FUNC(jlong, Pdfium, nativeSearchStart)(JNI_ARGS, jlong textPagePtr, jstring query,
...
JNI_FUNC(void, Pdfium, nativeSearchStop)(JNI_ARGS, jlong searchHandlePtr) {
    FPDF_SCHHANDLE search = reinterpret_cast<FPDF_SCHHANDLE>(searchHandlePtr);
    FPDFText_FindClose(search);
}

JNI_FUNC(jboolean, Pdfium, nativeSearchNext)(JNI_ARGS, jlong searchHandlePtr) {
    FPDF_SCHHANDLE search = reinterpret_cast<FPDF_SCHHANDLE>(searchHandlePtr);
    FPDF_BOOL result = FPDFText_FindNext(search);
    return result ? JNI_TRUE : JNI_FALSE;
}

JNI_FUNC(jboolean, Pdfium, nativeSearchPrev)(JNI_ARGS, jlong searchHandlePtr) {
    FPDF_SCHHANDLE search = reinterpret_cast<FPDF_SCHHANDLE>(searchHandlePtr);
    FPDF_BOOL result = FPDFText_FindPrev(search);
    return result ? JNI_TRUE : JNI_FALSE;
}

JNI_FUNC(jint, Pdfium, nativeGetCharIndexOfSearchResult)(JNI_ARGS, jlong searchHandlePtr) {
    FPDF_SCHHANDLE search = reinterpret_cast<FPDF_SCHHANDLE>(searchHandlePtr);
    return FPDFText_GetSchResultIndex(search);
}

JNI_FUNC(jint, Pdfium, nativeCountSearchResult)(JNI_ARGS, jlong searchHandlePtr) {
    FPDF_SCHHANDLE search = reinterpret_cast<FPDF_SCHHANDLE>(searchHandlePtr);
...
//////////////////////////////////////////
JNI_FUNC(jlong, Pdfium, nativeAddTextAnnotation)(JNI_ARGS, jlong docPtr, int page_index,
                                                 jstring text_,
    ...
    jclass clazz = env->FindClass("arte/programar/pdfium/Pdfium");
